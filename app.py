...
def compliments_results():
    ...
    user_compliments = random.sample(list_of_compliments, k=num_compliments)
...
def animal_facts():
    ...
    print('getting animal facts')
    # TODO: Collect the form data and save as variables
    animal_fact = 'None.'
    animal_list = list(animal_to_fact.keys())
    user_choice = request.args.get('animal')
    print(animal_fact)
    print(animal_list)
    print(user_choice)
    if user_choice:
        animal_fact = animal_to_fact[user_choice]  
